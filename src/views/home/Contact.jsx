        ...
        <div className="w-full text-center">
          ...
          <form className='max-w-xl w-full mx-auto'>
            <div className="w-full mb-8 text-left">
              <label for="name" className='text-base  font-normal text-textMain mb-10'>Name</label>
              <input 
                id='name' 
                type="text" 
            ...
            <div className='w-full flex gap-8'>
              <div className="w-1/2 mb-6 text-left">
                <label for="email" className='text-base  font-normal text-textMain mb-10'>Email</label>
                <input 
                  id='email' 
                  type="text" 
                  className='mt-3 w-full bg-white text-dark p-3 rounded-md focus:outline-none ring-borderLight ring-1 focus:ring-primary focus:ring-2 focus:border-primary' />
              ...
              <div className="w-1/2 mb-6 text-left">
                <label for="subject" className='text-base  font-normal text-textMain mb-10'>Subject</label>
                <input 
                  id='subject' 
                  type="text" 
                  className='mt-3 w-full bg-white text-dark p-3 rounded-md focus:outline-none ring-borderLight ring-1 focus:ring-primary focus:ring-2 focus:border-primary' />
            ...
            <div className="w-full mb-6 text-left">
              <label for="message" className='text-base font-normal text-textMain mb-10'>Message</label>
              <textarea 
                id='message' 
            ...
            <div className="w-full flex flex-wrap justify-between gap-6">
              <div className='flex items-center gap-3'>
                ...
                <div className='text-left'>
                  <label for="show-email" className='text-base font-semibold text-black'>Email</label>
          ...
          <div className='w-full py-4'>
            <div className='w-full flex justify-center items-center gap-6'>
              <a href='#text' target="_blank" rel="noreferrer noopener">
                <i class="fab fa-linkedin text-2xl text-textMain hover:text-primary duration-300 transition ease-in-out"></i>
              </a>
              <a href='#text' target="_blank" rel="noreferrer noopener">
                <i class="fab fa-github text-2xl text-textMain hover:text-primary duration-300 transition ease-in-out"></i>
              </a>
              <a href='#text' target="_blank" rel="noreferrer noopener">
                <i class="fab fa-instagram text-2xl text-textMain hover:text-primary duration-300 transition ease-in-out"></i>
              </a>
              <a href='#text' target="_blank" rel="noreferrer noopener">
                <i class="fab fa-youtube text-2xl text-textMain hover:text-primary duration-300 transition ease-in-out"></i>
              </a>
            </div>
          </div>
        </div>
